        ...
        <div className="w-layout-grid footer-top-wrapper">
          <div className="footer-left-wrapper">
            ...
            <div className="w-layout-grid social-link-wrap">
              ...
              <a href="https://x.com/haplaborg" target="_blank" className="social-link w-inline-block">
                <div className="social-icon w-embed">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    {/* SVG de X/Twitter */}
          ...
          <div className="w-layout-grid footer-items-grid">
            <div className="footer-column">
              <div className="text-block-11">Menu</div>
              {/* Aquí usamos <Link> y rutas limpias */}
              <Link href="/" className="footer-link">Home</Link>
              <Link href="/formal-bases" className="footer-link">Formal Bases</Link>
              <Link href="/indicators" className="footer-link">Indicators</Link>
            </div>
          </div>
          <div className="footer-column">
            <div className="text-block-11">Contact Us</div>
            <a href="mailto:info@haplab.org" className="footer-link">info@haplab.org</a>
          </div>
        </div>
        <div className="footer-bottom-wrapper">
          <div className="footer-credit-text">© 2024 HAPLAB. All right reserved.</div>
        </div>
      </div>
    </div>
  );
